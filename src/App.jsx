...
export default function App() {
  ...
  function sendMessage(){
    ...
    setTimeout(()=>{
      ...
      if(shouldAskFollowUp){
        ...
        const followUps = responseData.followUps;
  ...
  return (
    ...
    <div className="h-screen overflow-hidden bg-black text-white relative font-sans">
        ...
        <div className="max-w-4xl mx-auto px-5 pt-10">
          ...
          {messages.map((msg,index)=>(
            ...
            >
              ...
              <div
                className={`max-w-[75%] px-5 py-4 rounded-3xl text-[15px] leading-7 backdrop-blur-xl border transition-all duration-300 ${
                  msg.sender === "user"
      ...
      <div className="absolute bottom-0 w-full flex justify-center px-5 pb-6 bg-gradient-to-t from-black via-black/90 to-transparent z-20">
        ...
        <div className="w-full max-w-4xl bg-zinc-900/90 border border-white/10 rounded-full flex items-center p-2 backdrop-blur-2xl">
          ...
          <button
            onClick={sendMessage}
            className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-700 hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center shadow-[0_0_25px_rgba(0,140,255,0.55)]"
          >
